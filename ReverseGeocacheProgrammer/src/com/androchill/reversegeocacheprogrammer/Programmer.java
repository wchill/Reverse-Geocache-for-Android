...
public class Programmer extends IOIOFragmentActivity {
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			...
			switch (position) {
			case 0:
				return getString(R.string.information_title).toUpperCase(l);
			case 1:
				return getString(R.string.programmer_title).toUpperCase(l);
			}
			return null;
		}
	}
